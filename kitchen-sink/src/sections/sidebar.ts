...
export const sidebarSection: Section = {
  ...
  render(host) {
    ...
    host.appendChild(card({
      ...
      intro: "A real NSSplitViewItem sidebar (this window's left nav). Toggling hides the nav; the toolbar's sidebar button brings it back. Collapse/resize gating controls whether the user can collapse it or drag the divider (set at create time too, via sidebar.collapsible / sidebar.resizable).",
      buttons: [
